      	...
      	<div class="span8">
      		...
      		<div class="widget stacked">
				...
				<div class="widget-content">
					...
					<div class="faq-list">
						<ul>
							<li class="<?php echo $tiket_inf['id']; ?>">
								<div id="div_1">
									<div id="avatar">
										<a href="#">
<?php 
										echo '<img src="'.user_avatar($tiket_inf['user_id']).'" id="pavatar" />';
?>										
										</a>
									</div>
								</div>
								<div id="div_3">
							<?php 	
										echo user_imep($tiket_inf['user_id']);
									?>
									 kaže: <span style="float: right; color:#9BA6A6; font-size: 11px; font-style: italic;">pre <?php echo time_elapsed_A($nowtime-$tiket_inf['vreme_odgovora']).' - '.vreme($tiket_inf['vreme_odgovora']); ?></span> <br />
									<div id="poruka">
										<?php echo makeClickableLinks($tiket_inf['poruka']); ?>
<?php 
										echo'<hr><font style="color: rgba(0,0,0,0.6); font-size: 11px;">'.$admin['signature'].'</font>';
										?>
									</div>
								</div>
							</li>
