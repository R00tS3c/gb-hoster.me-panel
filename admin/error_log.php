...
$fajl = "errorlog";
	...
	$sql = "SELECT * FROM `error_log` WHERE `vrsta` = '1' ORDER by `id` DESC LIMIT $start, $limit";
				...
				<div class="widget-content">
					...
					<?php	
							if(mysql_num_rows($result) == 0) {
								echo'<tr><td colspan="5"><m>Trenutno nema error logova.</m></td></tr>';
							}
