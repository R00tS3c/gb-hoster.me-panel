...
$sql = "SELECT * FROM `billing` ORDER by `id` DESC LIMIT $start, $limit";
								...
								<table class="table table-striped table-bordered tabela-asd">
									...
									<tbody>
										...
										while($row = mysql_fetch_array($result)) {
											...
											if($lokacija == 1) {
												$lokacija = "<img src='https://gb-hoster.me/assets/img/icon/country/DE.png'>";
											} else if($lokacija == 2) {
												$lokacija = "<img src='https://gb-hoster.me/assets/img/icon/country/PL.png'>";
											} else if($lokacija == 3) {
												$lokacija = "<img src='https://gb-hoster.me/assets/img/icon/country/FR.png'>";
											} else if($lokacija == 4) {
												$lokacija = "<img src='https://gb-hoster.me/assets/img/icon/country/BG.png'>";
											} else {
												$lokacija = "<img src='https://gb-hoster.me/assets/img/icon/country/DE.png'>";
											}
